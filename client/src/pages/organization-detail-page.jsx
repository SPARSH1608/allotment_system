        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <div className="text-lg font-semibold text-green-600">
              ₹{stats.totalRevenue && !isNaN(stats.totalRevenue) ? stats.totalRevenue.toLocaleString() : "0"}
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                {["All", "Allotted", "Available"].map((tab) => (
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === tab ? "bg-blue-600 text-white" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"}`}
                  >
                    {tab} (
                    {tab === "All"
                      ? stats.totalLaptops
