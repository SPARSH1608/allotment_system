...
console.log("Organizations:", organizations)
  ...
  return (
    <div className="p-8">
            ...
            >
              ...
              <CardContent>
                ...
                <div className="flex justify-between items-center text-center pt-3 border-t border-gray-200">
                  <div>
                    <div className="text-2xl font-bold text-blue-600">{org.stats?.totalLaptops || 0}</div>
                    <div className="text-xs text-gray-500">Total Laptops</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-green-600">{org.stats?.activeAllotments || 0}</div>
                    <div className="text-xs text-gray-500">Active</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-red-600">{org.stats?.overdueAllotments || 0}</div>
      ...
      <AddOrganizationModal isOpen={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} onSubmit={handleAddOrganization} />
    </div>
  )
}
